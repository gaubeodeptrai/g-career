...
<head>
<meta charset="utf-8">
<title>エリアから探す｜<?php echo h($GLOBALS["PAGETITLE"]);?></title>
<meta name="description" content="エリアから探すのページです。<?php echo h($GLOBALS["PAGDESCRIPTION"]);?>">
...
<article id="Contents">
	<section class="com_pnkzbox m_b10">
		<ul class="clearfix" itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			...
			<li itemprop="title"><span class="clr_gr">&gt;</span>&nbsp;&nbsp;エリアから探す</li>
		</ul>
	</section>
	<section id="SRCBX">
		<section id="Clmbox" class="com_wid clearfix">
			<section id="Mainbox">
					...
					<div class="srclistbox">
						<h2 class="com_tlx"><img src="/callcenter/images/title_area.png" alt="エリアから探す" ></h2>
						<h2 class="com_spttl"><img src="/callcenter/images/sp_top_ttl_area.png" alt="エリアから探す" height="26"></h2>
    						...
    						foreach($_["prefGroups"] as $t){
    							...
    							foreach($_["prefectures"][$t["gp_id"]] as $v){
    							    if(!empty($_["prefRec"][$v["id"]])){
    							        echo '<li><a href="/callcenter/area';
